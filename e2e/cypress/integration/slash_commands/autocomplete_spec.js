...
describe('Integrations', () => {
    ...
    it('DONE - T2829 Test an example of plugin that uses sub commands', () => {
    ...
    it('DONE - T2830 Test an example of a plugin using static list', () => {
        // # Post a slash command with trailing space
        cy.get('#post_textbox').clear().type('/jira ');
    ...
    it('DONE - T2831 Test an example of plugin using dynamic list', () => {
        // # Post a slash command with trailing space
    ...
    it.only('T2832 Use a slash command that omits the optional argument', () => {
    ...
    it.only('T2833 Use a slash command that accepts an optional argument', () => {
    ...
    it('DONE - T2834 Slash command help stays visible for system slash command', () => {
    ...
    it('DONE - T2835 Slash command help stays visible for plugin', () => {
        // # Post a slash command with trailing space
        cy.get('#post_textbox').clear().type('/jira ');
